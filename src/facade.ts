import { Callback, FileSystem } from "./types";
...
export interface Facade {
   ...
   */
  forEach<T>(array: T[], iterator: Iterator<T>, done: Callback<void>): void;
}
 ...
 * @internal
 */
export type Iterator<T> = (item: T, callback: Callback<void>) => void;
