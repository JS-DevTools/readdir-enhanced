...
function normalizeOptions (options, internalOptions) {
  ...
  var recurseDepth, recurseFn, deep = options.deep;
  if (deep === null || deep === undefined || typeof deep === 'boolean') {
    ...
    throw new TypeError('options.deep must be a boolean, number, or function');
  }
